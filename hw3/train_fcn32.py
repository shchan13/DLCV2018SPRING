...
from keras.layers import Permute, Reshape, Activation, Cropping2D
...
def load_model(weight_name, n_classes, img_size):
    ...
    print('model output shape = ', o_shape)
...
def get_val(img_num, train_path, img_size, n_classes):
    ...
    # np.save('val_img_v2.npy', val_img)
    # np.save('val_label_v2.npy', val_label)
...
def main():
    ...
    model_path = FILE_PATH + 'model/vgg16fcn32_weight_azure.hdf5'
    ...
    # Save history
    with open('./trainHistoryDict.history', 'wb') as file_pi:
